...
val create_request :
  node ref -> ?request_ack:bool -> Address.t -> bytes * bytes option -> Message.t Lwt.t
...
val create_response :
  node ref -> ?request_ack:bool -> Message.t -> bytes * bytes option -> Message.t
...
(** [create_post node payload] creates a [Message.t] of the {i Post category}
    ...
    entire network. *)
val create_post : node ref -> ?request_ack:bool -> bytes * bytes option -> Message.t
